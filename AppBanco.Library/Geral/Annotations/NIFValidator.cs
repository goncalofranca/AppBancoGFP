...
{
    public class NIFValidator : ValidationAttribute
    {
        private readonly string _msg;

        public NIFValidator(string ErrorMessage) => _msg = ErrorMessage;
        public override bool IsValid(object value) =>
            // se for vazia retorna false se for true retorna o resulta da funcao valida contribuite
            string.IsNullOrWhiteSpace(value.ToString()) ? false : IsValidContrib(value.ToString());
        ...
        private bool IsValidContrib(string Contrib)
        {
